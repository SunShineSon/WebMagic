...
public class getGirlInfo implements PageProcessor {
    ...
    public void process(Page page) {
    	page.putField("url", page.getHtml().xpath("//div[@class='pic']/a/img/@src").all());
    ...
    public static void main(String[] args) throws JMException {
    	...
    	testSpider.addUrl("http://search.baihe.com/solrAdvanceSearch.action");
